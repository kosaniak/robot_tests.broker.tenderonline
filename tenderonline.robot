...
${host}=  http://tender-online.com.ua
...
Заповнити поля для допорогової закупівлі
  ...
  Select From List By Value  name=Tender[procuringEntity][contactPoint][fio]  62
...
Заповнити поля для понадпорогів
  ...
  Input Date  name=Tender[tenderPeriod][endDate]  ${tender_data.data.tenderPeriod.endDate}
  Wait And Select From List By Value  name=Tender[procuringEntity][contactPoint][fio]  62
...
Відповісти на вимогу про виправлення умов лоту
  [Arguments]  ${username}  ${tender_uaid}  ${complaintID}  ${answer_data}
  tenderonline.Відповісти на вимогу про виправлення умов закупівлі  ${username}  ${tender_uaid}  ${complaintID}  ${answer_data}
...
Створити чернетку вимоги про виправлення умов закупівлі
  ...
  ${complaint_id}=  tenderonline.Створити вимогу про виправлення умов закупівлі  ${username}  ${tender_uaid}  ${claim}
  [Return]  ${complaint_id}
...
Створити чернетку вимоги про виправлення умов лоту
  ...
  ${complaint_id}=  tenderonline.Створити вимогу про виправлення умов закупівлі  ${username}  ${tender_uaid}  ${claim}  ${None}  ${lot_id}
  [Return]  ${complaint_id}
...
Отримати документ до лоту
  ...
  ${file_name}=   tenderonline.Отримати документ   ${username}  ${tender_uaid}  ${doc_id}
  [Return]  ${file_name}
...
Conv And Select From List By Value
  ...
  ${smth_to_select}=  convert_string_from_dict_tenderonline  ${smth_to_select}
