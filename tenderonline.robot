...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'tenderonline_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  tenderonline.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Отримати інформацію із предмету
  ...
  ${return_value}=  Run Keyword If  '${field_name}' == 'contractPeriod.startDate'  tenderonline_service.convert_DMY_ISO  ${return_value}
  ...  ELSE IF  '${field_name}' == 'contractPeriod.endDate'  tenderonline_service.convert_DMY_ISO  ${return_value}
...
Отримати інформацію про items[${index}].contractPeriod.startDate
  ...
  ${return_value}=  tenderonline_service.convert_DMY_ISO  ${date_value}
  [return]  ${return_value}
...
Отримати інформацію про items[0].deliveryDate.endDate
  ...
  ${return_value}=  tenderonline_service.convert_date  ${date_value}
  [return]  ${return_value}
...
Додати предмет закупівлі
  ...
  tenderonline.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  tenderonline.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Дискваліфікувати постачальника
  ...
  tenderonline.Оновити сторінку з тендером  ${username}  ${tender_uaid}
  ${award_index}=  inc  ${award_index}
